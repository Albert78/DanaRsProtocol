...
object DanaRsPacketRegistry {
    ...
    val all: List<DanaRsPacketDefinition> = listOf(
        ...
        BASAL_SET_PROFILE_BASAL_RATE, BASAL_SET_PROFILE_NUMBER, BASAL_SET_TEMPORARY_BASAL,
        ...
        BOLUS_SET_EXTENDED_BOLUS, BOLUS_SET_EXTENDED_BOLUS_CANCEL, BOLUS_SET_STEP_BOLUS_START,
        BOLUS_SET_STEP_BOLUS_STOP, ETC_KEEP_CONNECTION, GENERAL_GET_PUMP_CHECK,
        GENERAL_GET_SHIPPING_INFORMATION, GENERAL_INITIAL_SCREEN_INFORMATION,
        GENERAL_SET_HISTORY_UPLOAD_MODE, HISTORY_ALARM, HISTORY_BASAL, HISTORY_BLOOD_GLUCOSE,
        HISTORY_BOLUS, HISTORY_CARBOHYDRATE, HISTORY_DAILY, HISTORY_PRIME, HISTORY_REFILL,
        HISTORY_SUSPEND, NOTIFY_ALARM, NOTIFY_DELIVERY_COMPLETE, NOTIFY_DELIVERY_RATE_DISPLAY,
